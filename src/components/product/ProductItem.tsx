...
const ProductItem = ({ product }) => {
  return (
    <div className="rounded border shadow-lg p-4 h-auto w-[220px] text-center ">
      <img src={`http://localhost:4000/images/${product.imageFilename}`} alt="device"  className="object-contain h-48 w-96 my-1"/>
      <hr />
